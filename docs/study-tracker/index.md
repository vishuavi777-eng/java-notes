...
- [Java Progress](java-progress.md)
- [Spring Boot Progress](spring-boot-progress.md)
- [REST API Progress](rest-api-progress.md)
- [SQL / MySQL Progress](sql-mysql-progress.md)
- [DSA Progress](dsa-progress.md)
- [Java Coding Problems Progress](java-coding-problems-progress.md)
- [Backend System Design Progress](backend-system-design-progress.md)
- [Interview Answers Progress](interview-answers-progress.md)

## Completion Rule

Mark a topic complete only when:

- [ ] I can explain the definition.
- [ ] I know why it matters.
- [ ] I can give one example.
- [ ] I know one common trap.
- [ ] I can answer it in interview language.
